                ...
                <div className="flex sm:flex-row flex-col">
                    {sourceCodeUrl && (
                        <Link
                            href={sourceCodeUrl}
                            target="_blank"
                            className="flex items-center rounded bg-neutral-900 px-8 py-4 text-xl text-white transition-colors hover:bg-neutral-700 "
                        >
                    ...
                    {hasLiveUrl && (
                        <Link
                            ...
                            target="_blank"
                            className="sm:ml-5 mt-5 sm:mt-0 flex items-center rounded bg-neutral-900 px-8 py-4 text-xl text-white transition-colors hover:bg-neutral-700 "
                        >
