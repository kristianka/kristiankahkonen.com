...
export default function Buttons({ title, text, url }: ButtonsProps) {
    ...
    return (
        <div className="mx-auto my-5 flex justify-end gap-5">
            ...
            <button
                onClick={shareTo}
                className="flex cursor-pointer rounded-full border border-black bg-white px-4 py-2 text-sm hover:bg-blue-500 sm:px-10 sm:py-2 dark:border-white dark:bg-black dark:text-white dark:hover:text-blue-500"
            >
